...
<html>
<head>
    <title> Groups of the professor </title>
            ...
            <div class="acceuil-left_medium  acceuil-left_medium_specialitieScholar">
                ...
                <div class="list-moduls-professor">
                    <c:forEach items="${groups}" var="group">
                        <!-- <div class="card-group-container card-speciality-container">
                            <div class="card-speciality_header">
                                <span> ${group.group_abbreviation} </span>
                            </div>
                            <div class="card-speciality_body">
                                <span> ${group.field.field_abbreviation} ~ ${group.group_year} </span>
                                <span> ${group.group_creationDate} </span>
                            </div>
                            <div class="card-speciality_footer">
                                <a href="${pageContext.request.contextPath}/group?group_id=<c:out value='${group.group_id}' />"> <i class="fa fa-long-arrow-right"></i></a>
                            </div>
                        </div>  -->
